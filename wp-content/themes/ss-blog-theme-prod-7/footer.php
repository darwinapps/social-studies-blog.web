<!-- Begin footer -->
        ...
        <div class="col-6">
            <div class="row">
                <div class="col-12 pt-5">
                    <h2>We'll do anything for a good time.</h2>
                </div>
                ...
                <div class="col-6 pt-3">
                    ...
                    <p class="font-left35-light" style="font-size: 14px">No cover charge. Just high quality emails, delivery occasionally</p>
                    ...
                    <div class="input-group mb-3 ">
                        ...
                        <!-- Suscription  -->
                        <?php if ( is_active_sidebar( 'footer_jetpack_suscription' ) ) : ?>
                            <?php dynamic_sidebar( 'footer_jetpack_suscription' ); ?>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-6 pt-3">
    ...
    <div class="row mx-1 footer-mode-mobile">
        <div class="col-12">
            <h3 style="font-size: 40px;">We'll do anything for a good time.</h3>
        </div>
        ...
        <div class="col-12 mt-3">
            ...
            <p style="font-size: 14px">No cover charge. Just high quality emails, delivery occasionally</p>
            <div class="input-group mb-3 ">
                <input type="text" class="form-control form-email-footer font-left35-light" placeholder="Email Address" aria-label="Email Address" aria-describedby="basic-addon2" style="font-size: 10px; height: 42px; border-radius: 0px;">
                <div class="input-group-append">
                    <button class="btn btn-outline-secondary form-email-footer" type="button" style="border-radius: 0px; height: 42px;"><div style="font-size: 10px"> <i class="fas fa-arrow-right"></i></div></button>
    ...
    <div class="container-fluid mt-3 py-1 footer-end">
        <span style="font-size: 10px">2019, Social Studies.</span>
    </div>
