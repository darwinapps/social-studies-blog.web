    ...
    <?php
        if($latest_posts):
            ...
            <div class="hero-container-inner text-center">
                ...
                <a href="<?php the_permalink();?>">
                    <div class="center-excerpt font-left35-regular"><?php $excerpt = get_the_excerpt(); $trimmed_content = wp_trim_words( $excerpt, $num_words = 100, $more = ' ' ); ;echo $trimmed_content;?></div>
                </a>
