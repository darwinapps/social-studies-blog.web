...
function my_theme_scripts() {
	...
	wp_enqueue_style( 'ss-blog-style', get_stylesheet_uri(), array(), '1.1' );
    ...
    wp_register_script( 'gdgt-base', get_template_directory_uri() . '/js/helper.js', array( 'jquery' ), NULL, false );
