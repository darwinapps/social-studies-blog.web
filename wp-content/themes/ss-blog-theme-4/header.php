...
<?php     
    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-white d-flex justify-content-between section-shop-desktop">
            ...
            <button class="form-in-navbar btn my-2 my-sm-0" type="submit" onclick="search();"><i class="fas fa-search"></i></button>  
            <a href="<?php get_home_url();?>/?cat=0" style="text-decoration: none;"><h1 class="form-in-navbar brand-name-single mb-0">The Social</h1></a>
                  
            <button class="navbar-toggler text-danger" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
                ...
                <button class="form-out-navbar  btn my-2 my-sm-0" type="submit" onclick="search();"><i class="fas fa-search"></i></button>                                           
    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-white d-flex ">
            ...
            <button class="form-in-navbar ml-auto btn my-2 my-sm-0" type="submit" onclick="search();"><i class="fas fa-search"></i></button>  
            <button class="navbar-toggler text-danger" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
                aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" style="border: none;">               
                Menu
            </button>
                ...
                <button class="form-out-navbar ml-auto btn my-2 my-sm-0" type="submit" onclick="search();"><i class="fas fa-search"></i></button> 
            </div>
        </nav>
    </div>
    <?php endif;?>
