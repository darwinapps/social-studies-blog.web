...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-143600692-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-143600692-2');
</script>
...
function my_theme_scripts() {
	...
	wp_enqueue_style( 'ss-blog-style', get_stylesheet_uri(), array(), '1.5' );
