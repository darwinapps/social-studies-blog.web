    ...
    <div class="container-fluid my-1 my-lg-5 pt-4 pt-lg-5 px-0">
      ...
      <div class="row mx-0 my-5 d-flex justify-content-center">
        <div class="col-12 d-flex justify-content-center justify-content-lg-end align-items-center col-lg-4 ">
          ...
          <div class="mx-3 w-25 w-lg-0 text-left text-lg-right font-atlas" style="font-size: 12px;">
            <?php
			  $post_key_flag = false;
              if (!empty($post_keys)) :
                foreach ($post_keys as $pkey) :
        ...
        <div class="col-12 d-flex justify-content-center justify-content-lg-start align-items-center col-lg-4 ">
          <div class="d-none d-lg-block mx-3 vl"></div>
          <span class="mx-3 w-25 w-lg-0 text-right text-lg-left font-left35-medium" style="font-size: 10px;" >PHOTOS BY</span>
          <div class="mx-3 w-50 w-lg-0 text-left text-lg-left font-atlas" style="font-size: 12px;" >
          <?php
			$post_key_flag = false;
            if (!empty($post_keys)) :
              foreach ($post_keys as $pkey) :
