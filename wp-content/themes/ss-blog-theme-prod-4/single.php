      ...
      <div class="row mx-0 my-5 d-flex justify-content-center">
        ...
        <div class="col-12 px-lg-0 col-lg-2 col-xl-2 d-flex justify-content-center align-items-center ">
          ...
          <div class="mx-0 mx-md-3 mr-lg-0 w-50 w-lg-0 d-flex justify-content-start justify-content-lg-end">
            <div class="font-atlas" style="font-size: 12px;cursor: pointer;margin: 0 0;" data-href="https://social-studies.blog/" data-layout="button" data-size="small"><a onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=socialstudies578844844.wpcomstaging.com', '_blank', 'width=700,height=800');">FB</a></div>
