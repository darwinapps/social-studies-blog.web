                ...
                <div class="col-12 col-md-6 d-flex align-items-start">
                    ...
                    <!-- card-img-top img-fluid -->
                        <a href="<?php the_permalink();?>"><?php if ( has_post_thumbnail() ) {
                                the_post_thumbnail('post-thumbnails', array( 'class' => 'size-overflow-thumbnails-index card-img-top img-fluid' ) );
                            }?></a>
    ...
    <div class="container-fluid py-5 widget-area ">
        <div class="row d-flex">
            ...
            <div class="col-12 py-4 px-md-0 text-center text-danger px-0">
                <a href="https://social-studies.blog/2020/01/15/pop-quiz-with-cleo" style="text-decoration: none;"><h2 class="text-special px-md-0 mx-md-0">Sometimes I will draw my invite and then take a photo of the drawing and text that around. Efficient and eco-friendly.</h2></a>
            </div>
            <div class="col-12 text-center text-danger">
                <h5> - Cleo Wade</h5>
            </div>
