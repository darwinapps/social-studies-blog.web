        ...
        <div class="col-12 col-lg-5 mr-lg-0 px-lg-0">
          <div class="row px-lg-0" >
            ...
            <div class="col-8">
              ...
              <a onclick="window.open('https://pinterest.com/pin/create/button/?url=<?php the_permalink();?>&media=https%3A//i0.wp.com/<?php get_the_post_thumbnail_url(get_the_ID(),'full'); ?>?w=1000%26ssl=1%25201000w,%2520https%3A//i0.wp.com/<?php get_the_post_thumbnail_url(get_the_ID(),'full'); ?>?resize=300%252C200%26ssl=1%2520300w,%2520https%3A//i0.wp.com/<?php get_the_post_thumbnail_url(get_the_ID(),'full'); ?>?resize=768%252C512%26ssl=1%2520768w&description==')">PIN</a> </div>
            </div>
          </div>
        </div>
      </div>
